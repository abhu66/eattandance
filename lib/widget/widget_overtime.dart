...
class WidgetOvertime extends StatefulWidget {
  final dashboardItem = [
    ...
    new DashboardItem(
        "Generate OT", Icons.timelapse, Color(0xffFFF3F3), Color(0xffFD706B)),
  ];

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _WidgetOvertimeState();
  }
}
...
class _WidgetOvertimeState extends State<WidgetOvertime> {
